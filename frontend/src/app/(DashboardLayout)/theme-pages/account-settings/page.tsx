...
import { IconArticle, IconBell, IconCategory, IconLock, IconUserCircle } from '@tabler/icons-react';
...
import CategoryTab from '@/app/(DashboardLayout)/components/pages/account-setting/CategoryTab';
import MybodydataTab from '../../components/pages/account-setting/Mybodydata';
