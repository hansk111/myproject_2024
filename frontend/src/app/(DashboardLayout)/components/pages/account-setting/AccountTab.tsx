...
import { useGetUserAvatarQuery, usePutUserAvatarMutation } from '@/store/auth/authApiSlice';
...
const AccountTab = () => {
  ...
  const { data: avatar, isLoading } = useGetUserAvatarQuery();
      ...
      <Grid item xs={12} lg={6}>
        <BlankCard>
          <CardContent>
            ...
            <Typography color="textSecondary" mb={3}>프로파일 이미지를 교체하세요</Typography>
            <Box textAlign="center" display="flex" justifyContent="center">
              <Box>
                <Avatar
                  src={preview ? preview : avatar?.image}
                  alt={"user1"}
