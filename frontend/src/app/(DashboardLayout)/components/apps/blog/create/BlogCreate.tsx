...
const BlogCreate = () => {
  ...
  console.log("🚀 ~ BlogCreate ~ values:", values)
  ...
  const handleSubmit = async (event: any) => {
    ...
    // switch (String(values.categories)) {
    //   case "여행":
    //     ca_num = 1;
    //     break;
    //   case "식물":
    ...
    // // console.log("🚀 ~ handleSubmit ~ formData:", values.coverImg);
  ...
  return (
    <>
      {/* breadcrumb */}
      <Breadcrumb title="Blog Post Create" items={BCrumb} />
      {/* end breadcrumb */}

      <Grid container spacing={3}>
        <Grid item lg={12} md={12} xs={12}>
          <ParentCard title="Post Create">
            <form onSubmit={handleSubmit}>
              ...
              <FileInput
                ...
                initialPreview={values.initialPreview}
