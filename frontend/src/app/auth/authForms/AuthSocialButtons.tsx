...
import { continueWithGoogle, continueWithFacebook } from "@/utils/social";

const AuthSocialButtons = ({ title }: signInType) => (
  <>
    <Stack direction="row" justifyContent="center" spacing={2} mt={3}>
      <CustomSocialButton onClick={continueWithGoogle}>
        <Avatar
      ...
      <CustomSocialButton onClick={continueWithFacebook}>
        <Avatar
